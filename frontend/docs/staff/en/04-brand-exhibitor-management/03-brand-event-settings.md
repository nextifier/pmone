---
title: "Brand event settings"
description: "How to configure booth details and event-specific brand information."
...
1. Open the event and go to the **Brands** tab
2. Click the brand you want to configure
3. Update the booth information
...
If the project has custom brand fields configured (see [Custom fields and business categories](../02-project-management/03-custom-fields-business-categories.md)), they appear here as additional form fields. Fill them in as needed.
...
- [Importing and exporting brands](./04-importing-exporting-brands.md) - bulk operations for brand data
