...
description: "How to place a product order for your booth."
section: "orders"
order: 2
locale: "en"
audience: "exhibitor"
...
Your order goes to the event organizer who updates its status as they process it. You can track the progress from your order list (see [Tracking order status](./03-tracking-order-status.md)).
