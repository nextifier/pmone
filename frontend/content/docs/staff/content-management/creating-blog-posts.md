...
description: "How to write, edit, and publish blog posts for your event websites."
...
2. Click **Create**
3. The full-screen editor opens with a clean writing area
...
The editor supports rich text: headings, bold, italic, lists, links, images, and embedded media. See [Using the editor](./02-using-the-editor.md) for details on the editor features.
