  ...
  <component
    ...
    :class="cn(
      ...
      isRange && [
        ...
        '[&:has([data-selection-start])]:isolate [&:has([data-selection-start])]:z-0 [&:has([data-selection-start])]:rounded-l-(--cell-radius) [&:has([data-selection-start])]:bg-muted [&:has([data-selection-start])]:after:absolute [&:has([data-selection-start])]:after:inset-y-0 [&:has([data-selection-start])]:after:right-0 [&:has([data-selection-start])]:after:w-4 [&:has([data-selection-start])]:after:bg-muted',
        '[&:has([data-selection-end])]:isolate [&:has([data-selection-end])]:z-0 [&:has([data-selection-end])]:rounded-r-(--cell-radius) [&:has([data-selection-end])]:bg-muted [&:has([data-selection-end])]:after:absolute [&:has([data-selection-end])]:after:inset-y-0 [&:has([data-selection-end])]:after:left-0 [&:has([data-selection-end])]:after:w-4 [&:has([data-selection-end])]:after:bg-muted',
