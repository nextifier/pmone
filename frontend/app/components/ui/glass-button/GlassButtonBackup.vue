...
/* =========================
   INVERT VARIANT - Simple opaque button
   ========================= */

/* Invert: Simple opaque bg-background with text-foreground */
.glass-button-variant-invert .glass-button {
...
.glass-button-variant-invert .glass-button:hover {
  transform: scale(0.975);
  background: var(--color-background);
  opacity: 0.9;
}

.glass-button-variant-invert .glass-button::after {
  display: none;
}

.glass-button-variant-invert .glass-button-text {
  color: var(--color-foreground);
  font-weight: 500;
}

.glass-button-variant-invert .glass-button-text::after {
  display: none;
}

.glass-button-variant-invert .glass-button-shadow {
  display: none;
}

/* Dark mode - Invert */
:global(.dark .glass-button-variant-invert .glass-button) {
  background: var(--color-background);
}

:global(.dark .glass-button-variant-invert .glass-button:hover) {
  background: var(--color-background);
  opacity: 0.9;
}

:global(.dark .glass-button-variant-invert .glass-button-text) {
  color: var(--color-foreground);
}

/* =========================
   OUTLINE-INVERT VARIANT - Dark glass for light backgrounds
   ========================= */

/* Outline-invert: Same as default variant (dark glass) */
.glass-button-variant-outline-invert .glass-button {
  background: linear-gradient(
    -75deg,
    rgba(0, 0, 0, 0.85),
    rgba(0, 0, 0, 0.95),
...
.glass-button-variant-outline-invert .glass-button:hover {
  transform: scale(0.975);
  backdrop-filter: blur(0.01em);
  -webkit-backdrop-filter: blur(0.01em);
  box-shadow:
...
.glass-button-variant-outline-invert .glass-button::after {
  background:
    conic-gradient(
      from var(--angle-1) at 50% 50%,
      rgba(255, 255, 255, 0.3),
...
.glass-button-variant-outline-invert .glass-button-text {
  color: var(--color-white, #fff);
}

.glass-button-variant-outline-invert .glass-button:hover .glass-button-text {
  text-shadow: 0.025em 0.025em 0.025em rgba(255, 255, 255, 0.2);
}

.glass-button-variant-outline-invert .glass-button-text::after {
  background: linear-gradient(
    var(--angle-2),
    rgba(255, 255, 255, 0) 0%,
    rgba(255, 255, 255, 0.15) 40% 50%,
...
/* Active state for outline-invert variant */
.glass-button-variant-outline-invert:has(.glass-button:active) {
  transform: rotate3d(1, 0, 0, 25deg);
}

.glass-button-variant-outline-invert:has(.glass-button:active) .glass-button {
  box-shadow:
    inset 0 0.125em 0.125em rgba(255, 255, 255, 0.05),
    inset 0 -0.125em 0.125em rgba(0, 0, 0, 0.5),
    0 0.125em 0.125em -0.125em rgba(0, 0, 0, 0.3),
...
/* Dark mode - Outline-invert: Light glass (same as default dark mode) */
:global(.dark .glass-button-variant-outline-invert .glass-button) {
  background: linear-gradient(-75deg, rgb(240, 240, 240), rgb(250, 250, 250), rgb(240, 240, 240));
  box-shadow:
    inset 0 0.125em 0.125em rgba(0, 0, 0, 0.05),
    inset 0 -0.125em 0.125em rgba(255, 255, 255, 0.5),
...
:global(.dark .glass-button-variant-outline-invert .glass-button:hover) {
  transform: scale(0.975);
  background: linear-gradient(-75deg, rgb(230, 230, 230), rgb(245, 245, 245), rgb(230, 230, 230));
  box-shadow:
    inset 0 0.125em 0.125em rgba(0, 0, 0, 0.08),
...
:global(.dark .glass-button-variant-outline-invert .glass-button::after) {
  background:
    conic-gradient(
      from var(--angle-1) at 50% 50%,
      rgba(0, 0, 0, 0.15),
...
:global(.dark .glass-button-variant-outline-invert .glass-button-text) {
  color: rgb(30, 30, 30);
}

:global(.dark .glass-button-variant-outline-invert .glass-button:hover .glass-button-text) {
  text-shadow: 0.025em 0.025em 0.025em rgba(0, 0, 0, 0.1);
}

:global(.dark .glass-button-variant-outline-invert .glass-button-text::after) {
  background: linear-gradient(
    var(--angle-2),
    rgba(255, 255, 255, 0) 0%,
    rgba(255, 255, 255, 0.5) 40% 50%,
...
:global(.dark .glass-button-variant-outline-invert:has(.glass-button:active) .glass-button) {
  background: linear-gradient(-75deg, rgb(195, 195, 195), rgb(210, 210, 210), rgb(195, 195, 195));
  box-shadow:
    inset 0 0.125em 0.125em rgba(0, 0, 0, 0.1),
    inset 0 -0.125em 0.125em rgba(255, 255, 255, 0.4),
