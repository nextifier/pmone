...
<template>
  <div
    :class="
      cn(
        'glass-button-wrap pointer-events-none relative isolate z-2 rounded-full [font-size:var(--global-size,1rem)] transition-all duration-(--transition-duration) ease-(--transition-ease) [--angle-1:-75deg] [--angle-2:-45deg] [--border-width:clamp(1px,0.0625em,4px)] [--shadow-offset:2em] [--transition-duration:400ms] [--transition-ease:cubic-bezier(0.25,1,0.5,1)] has-[.glass-button:active]:transform-[rotate3d(1,0,0,25deg)]',
        sizeClass,
        variantClass
      )
    "
    ...
    <div
      :class="
        cn(
          ...
          'after:absolute after:inset-0 after:top-[calc(var(--shadow-offset)-0.5em)] after:left-[calc(var(--shadow-offset)-0.875em)] after:z-0 after:box-border after:size-[calc(100%-var(--shadow-offset)-0.25em)] after:overflow-visible after:rounded-full after:bg-linear-to-b after:from-black/20 after:to-black/10 after:mask-exclude! after:p-[0.125em] after:opacity-100 after:transition-all after:duration-(--transition-duration) after:ease-(--transition-ease) after:[mask:linear-gradient(#000_0_0)_content-box,linear-gradient(#000_0_0)]',

          'peer-hover:blur-[clamp(2px,0.0625em,6px)] peer-hover:[transition:filter_var(--transition-duration)_var(--transition-ease)] peer-hover:after:top-[calc(var(--shadow-offset)-0.875em)]',

          'peer-active:blur-[clamp(2px,0.125em,12px)] peer-active:after:top-[calc(var(--shadow-offset)-0.5em)] peer-active:after:opacity-75'
        )
      "
    ></div>
  </div>
