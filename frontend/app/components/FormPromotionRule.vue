<template>
  <form @submit.prevent="handleSubmit" class="grid gap-y-8">
      ...
      <div class="frame-panel">
        <div class="grid grid-cols-1 gap-y-6">
          <Field :data-invalid="!!errors?.name">
            ...
            <Input id="name" v-model="form.name" type="text" required maxlength="255" :aria-invalid="!!errors?.name" />
          ...
          <Field :data-invalid="!!errors?.description">
            ...
            <Textarea id="description" v-model="form.description" rows="3" maxlength="2000" :aria-invalid="!!errors?.description" />
        ...
        <div class="grid grid-cols-1 gap-y-6">
          <div class="grid grid-cols-2 gap-x-2 gap-y-6">
            ...
            <Field :data-invalid="!!errors?.value_type">
              <FieldLabel for="value_type">Value Type</FieldLabel>
          ...
          <div v-if="!usesValueConfig" class="grid grid-cols-2 gap-x-2 gap-y-6">
            ...
            <Field :data-invalid="!!errors?.max_discount_amount">
              <FieldLabel for="max_discount_amount">Max Discount Cap (Rp)</FieldLabel>
              <InputGroup>
                <InputNumber
                  :aria-invalid="!!errors?.max_discount_amount"
          ...
          <div v-if="form.value_type === 'buy_x_get_y'" class="grid grid-cols-2 gap-x-2 gap-y-6">
            <Field :data-invalid="!!errors?.['value_config.buy_qty']">
              <FieldLabel for="buy_qty">Buy quantity (X)</FieldLabel>
              <InputNumber id="buy_qty" v-model="form.value_config.buy_qty" :min="1" :aria-invalid="!!errors?.['value_config.buy_qty']" />
            ...
            <Field :data-invalid="!!errors?.['value_config.get_free_qty']">
              <FieldLabel for="get_free_qty">Get free (Y)</FieldLabel>
              <InputNumber id="get_free_qty" v-model="form.value_config.get_free_qty" :min="1" :aria-invalid="!!errors?.['value_config.get_free_qty']" />
          ...
          <div v-if="form.value_type === 'tiered_percentage' || form.value_type === 'tiered_fixed_amount'" class="space-y-3">
            <div class="grid grid-cols-2 gap-x-2 gap-y-6">
              <Field>
                <FieldLabel for="metric">Tier Metric</FieldLabel>
            ...
            <Field :data-invalid="!!errors?.['value_config.tiers']">
              ...
              <div v-for="(tier, idx) in form.value_config.tiers ?? []" :key="idx" class="grid grid-cols-[1fr_1fr_auto] gap-2 items-center">
                <InputNumber v-model="tier.min" :min="0" placeholder="Min (qty/amount)" :aria-invalid="!!errors?.['value_config.tiers']" />
                <InputGroup>
                  <InputNumber
                    v-model="tier.value"
                    :min="0"
          ...
          <div v-if="form.value_type === 'bundle_price'" class="grid grid-cols-2 gap-x-2 gap-y-6">
            <Field :data-invalid="!!errors?.['value_config.bundle_qty']">
              <FieldLabel for="bundle_qty">Bundle quantity</FieldLabel>
              <InputNumber id="bundle_qty" v-model="form.value_config.bundle_qty" :min="1" :aria-invalid="!!errors?.['value_config.bundle_qty']" />
            ...
            <Field :data-invalid="!!errors?.['value_config.bundle_price']">
              <FieldLabel for="bundle_price">Bundle price (Rp)</FieldLabel>
              <InputGroup>
                <InputNumber
                  :aria-invalid="!!errors?.['value_config.bundle_price']"
                  id="bundle_price"
          ...
          <div v-if="form.value_type === 'free_addon'" class="grid grid-cols-2 gap-x-2 gap-y-6">
            <Field :data-invalid="!!errors?.['value_config.max_free_qty']">
              <FieldLabel for="max_free_qty">Max free units</FieldLabel>
              <InputNumber id="max_free_qty" v-model="form.value_config.max_free_qty" :min="1" placeholder="Unlimited" :aria-invalid="!!errors?.['value_config.max_free_qty']" />
            ...
            <Field>
              <FieldLabel>Target Line Categories</FieldLabel>
          ...
          <div class="grid grid-cols-2 gap-x-2 gap-y-6">
            <Field :data-invalid="!!errors?.currency">
              ...
              <Select v-model="form.currency">
                <SelectTrigger id="currency" class="w-full" :aria-invalid="!!errors?.currency"><SelectValue placeholder="Select currency" /></SelectTrigger>
                <SelectContent>
          ...
          <div class="grid grid-cols-2 gap-x-2 gap-y-6">
            <Field :data-invalid="!!errors?.min_purchase_amount">
              <FieldLabel for="min_purchase_amount">Minimum Purchase (Rp)</FieldLabel>
              <InputGroup>
                <InputNumber
                  :aria-invalid="!!errors?.min_purchase_amount"
            ...
            <Field :data-invalid="!!errors?.priority">
              ...
              <InputNumber id="priority" v-model="form.priority" :min="0" :max="32000" :aria-invalid="!!errors?.priority" />
    ...
    <div class="frame">
      ...
      <div class="frame-panel">
        <Field :data-invalid="!!errors?.stacking_mode">
          <FieldLabel for="stacking_mode">Stacking Mode</FieldLabel>
          <Select v-model="form.stacking_mode">
            <SelectTrigger class="w-full" :aria-invalid="!!errors?.stacking_mode"><SelectValue placeholder="Select stacking mode" /></SelectTrigger>
            <SelectContent>
      ...
      <div class="frame-panel">
        <div class="grid grid-cols-2 gap-x-2 gap-y-6">
          <Field :data-invalid="!!errors?.starts_at">
            <FieldLabel for="starts_at">Starts At</FieldLabel>
            <DatePicker
          ...
          <Field :data-invalid="!!errors?.ends_at">
            <FieldLabel for="ends_at">Ends At</FieldLabel>
            <DatePicker
    ...
    <div v-if="form.kind === 'penalty'" class="frame">
      ...
      <div class="frame-panel">
        <div class="space-y-6">
          <Field :data-invalid="!!errors?.trigger_type">
            <FieldLabel for="trigger_type">Trigger Type</FieldLabel>
            <Select v-model="form.trigger_type">
              <SelectTrigger class="w-full" :aria-invalid="!!errors?.trigger_type"><SelectValue placeholder="Select trigger" /></SelectTrigger>
              <SelectContent>
          ...
          <Field v-if="form.trigger_type === 'booking_window' || form.trigger_type === 'event_period'">
            <FieldLabel for="trigger_window">Window</FieldLabel>
          ...
          <div v-if="form.trigger_type === 'date_range'" class="grid grid-cols-2 gap-x-2 gap-y-6">
            <Field>
              <FieldLabel for="trigger_start">Start Date</FieldLabel>
              <DatePicker
            ...
            <Field>
              <FieldLabel for="trigger_end">End Date</FieldLabel>
              <DatePicker
                v-model="triggerEnd"
                with-time
                placeholder="Select end date & time"
          ...
          <div v-if="form.trigger_type === 'lead_time' || form.trigger_type === 'cancellation_window'" class="grid grid-cols-2 gap-x-2 gap-y-6">
            ...
            <Field>
              <FieldLabel for="trigger_operator">Operator</FieldLabel>
    ...
    <div class="frame">
      ...
      <div class="frame-panel">
        <div class="grid grid-cols-1 gap-y-6">
          <Field :data-invalid="!!errors?.target_types">
            <FieldLabel>Purchase Types</FieldLabel>
          ...
          <div class="grid grid-cols-2 gap-x-2 gap-y-6">
            <Field :data-invalid="!!errors?.event_id">
              <FieldLabel for="event_id">Event Scope (optional)</FieldLabel>
              <Input id="event_id" v-model.number="form.event_id" type="number" min="0" placeholder="Event ID" :aria-invalid="!!errors?.event_id" />
            ...
            <Field :data-invalid="!!errors?.project_id">
              <FieldLabel for="project_id">Project Scope (optional)</FieldLabel>
              <Input id="project_id" v-model.number="form.project_id" type="number" min="0" placeholder="Project ID" :aria-invalid="!!errors?.project_id" />
    ...
    <div class="frame">
      ...
      <div class="frame-panel">
        <div class="grid grid-cols-1 gap-y-6">
          <div class="grid grid-cols-2 gap-x-2 gap-y-6">
            <Field>
              <FieldLabel for="appl_min_nights">Minimum Nights</FieldLabel>
            ...
            <Field>
              <FieldLabel for="appl_min_qty">Minimum Quantity</FieldLabel>
          ...
          <Field>
            <FieldLabel for="appl_events">Event IDs (CSV)</FieldLabel>
          ...
          <Field>
            <FieldLabel for="appl_hotels">Hotel IDs (CSV)</FieldLabel>
            <Input id="appl_hotels" v-model="applicabilityForm.hotels" type="text" placeholder="e.g. 3, 7" />
          </Field>

          <Field>
            <FieldLabel for="appl_room_types">Room Type IDs (CSV)</FieldLabel>
          ...
          <Field>
            <FieldLabel for="appl_domains">Guest Email Domains (CSV)</FieldLabel>
          ...
          <Field>
            <FieldLabel>Weekdays (when promo is valid)</FieldLabel>
            <div class="flex flex-wrap gap-3">
          ...
          <Field orientation="horizontal">
            ...
            <FieldLabel for="appl_first_purchase" class="cursor-pointer">
              First purchase only
