...
export default defineComponentDoc({
  ...
  sections: [
    ...
    },
    {
      id: "donut-total",
      title: "Center total",
      description: "Per-segment gradients, rounded segments, a drop shadow, and a center total.",
      examples: ["donut-total"],
      align: "center",
    },
    {
      id: "donut-stats",
      title: "Center stats",
      description: "A center percentage with a legend below.",
      examples: ["donut-stats"],
      align: "center",
    },
    {
      id: "pie-pattern",
      title: "Pattern segments",
      description: "Mix solid and SVG-pattern segments in a single pie.",
      examples: ["pie-pattern"],
      align: "center",
    },
    {
      id: "donut-active",
      title: "Active segment",
      description: "Expand one segment outward with activeIndex.",
      examples: ["donut-active"],
      align: "center",
    },
  ],
  apiReference: [
    {
      ...
      props: [
        ...
        { name: "radius", type: "number", default: "null", description: "Explicit outer radius in px." },
        { name: "cornerRadius", type: "number", default: "0", description: "Rounded segment ends." },
        { name: "padAngle", type: "number", default: "0", description: "Gap between segments, in radians." },
        { name: "svgDefs", type: "string", default: "null", description: "Raw SVG <defs> string (gradients/patterns/filters)." },
        { name: "segmentFill", type: "(d) => string", default: "null", description: "Per-segment fill accessor; defaults to the row's fill then config color." },
        { name: "segmentStrokeColor", type: "string", default: "null", description: "Stroke drawn in the gap between segments (e.g. var(--background))." },
        { name: "segmentStrokeWidth", type: "number", default: "4", description: "Segment gap stroke width." },
        { name: "donutFilter", type: "string", default: "null", description: "SVG filter url applied to the donut group (e.g. a drop shadow)." },
        { name: "activeIndex", type: "number", default: "null", description: "Index of the segment rendered expanded." },
        { name: "activeOuterRadius", type: "number", default: "110", description: "Outer radius of the expanded active segment." },
      ],
    },
  ],
});
