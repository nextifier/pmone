<template>
  <div class="space-y-4">
    ...
    <div v-if="!rooms?.length" class="text-muted-foreground rounded-md border border-dashed py-8 text-center text-sm tracking-tight">
      No rooms available.
    </div>

    <div v-else class="space-y-3">
      <div v-for="room in rooms" :key="room.id" class="rounded-md border p-4 sm:p-5 space-y-4">
