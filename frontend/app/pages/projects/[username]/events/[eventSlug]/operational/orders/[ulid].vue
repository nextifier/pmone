  ...
  <div class="flex flex-col gap-y-6">
    ...
    <template v-else>
      ...
      <div
        ...
        class="border-destructive-foreground/30 bg-destructive/5 rounded-lg border p-4"
      >
        <div class="flex items-center gap-x-2">
          <Icon name="hugeicons:alert-circle" class="text-destructive-foreground size-4 shrink-0" />
          <h4 class="text-destructive-foreground font-medium tracking-tight">Cancellation Reason</h4>
        </div>
