...
class UserController extends Controller
{
    ...
    public function updateSettings(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'settings.appearance.baseColor' => ['nullable', 'string', 'in:native,neutral,stone,zinc,mauve,olive,mist,taupe'],
            'settings.appearance.theme' => ['nullable', 'string', 'in:native,neutral,stone,zinc,mauve,olive,mist,taupe,amber,blue,cyan,emerald,fuchsia,green,indigo,lime,orange,pink,purple,red,rose,sky,teal,violet,yellow'],
            'settings.appearance.chartColor' => ['nullable', 'string', 'in:native,neutral,stone,zinc,mauve,olive,mist,taupe,amber,blue,cyan,emerald,fuchsia,green,indigo,lime,orange,pink,purple,red,rose,sky,teal,violet,yellow'],
