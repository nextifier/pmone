...
class StoreProjectCustomFieldRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => ['required', 'string', Rule::in(CustomField::allowedTypesFor(CustomField::CONTEXT_BRAND))],
    ...
    {
        return [
            'label.en.required' => 'Label is required.',
