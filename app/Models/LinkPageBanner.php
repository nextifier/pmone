 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|LinkPageBanner whereCaption($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|LinkPageBanner whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|LinkPageBanner whereCreatedBy($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|LinkPageBanner whereDeletedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|LinkPageBanner whereEndsAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|LinkPageBanner whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|LinkPageBanner whereIsActive($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|LinkPageBanner whereLinkPageId($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|LinkPageBanner whereSortOrder($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|LinkPageBanner whereStartsAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|LinkPageBanner whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|LinkPageBanner whereUpdatedBy($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|LinkPageBanner whereUrl($value)
