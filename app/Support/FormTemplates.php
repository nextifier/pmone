        ...
        return [
            ...
            'field-showcase' => [
                ...
                'fields' => [
                    ...
                    ['type' => 'month_range', 'label' => 'Month Range'],
                    ['type' => 'year', 'label' => 'Year', 'validation' => ['min' => 1990, 'max' => 2030]],
                    ['type' => 'year_range', 'label' => 'Year Range', 'validation' => ['min' => 1990, 'max' => 2030]],
                    ['type' => 'time_range', 'label' => 'Time Range', 'help_text' => 'End time must not be earlier than start time.'],
