...
return [
     ...
     */
    'path_generator' => App\Support\PathGenerator\CollectionBasedPathGenerator::class,
     ...
     */
    'image_optimizers' => env('DISABLE_IMAGE_OPTIMIZERS', false) ? [] : [
        // Only include optimizers that are available in production
        ...
        // Disable problematic optimizers in production
