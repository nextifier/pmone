...
return [
    ...
    | so conversions never upscale (largest conversion in this app is 1600).
    |
    */

    'original_max_dimension' => (int) env('IMAGE_ORIGINAL_MAX', 2560),

    'original_quality' => (int) env('IMAGE_ORIGINAL_QUALITY', 90),
