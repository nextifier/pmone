@extends('pdf._layout', ['title' => $receiptNumber])
        ...
        <td class="w-1/2 align-top pl-4">
            <table class="w-full py-1">
                <tr>
                    ...
                    <td class="text-[13px] text-right text-black align-middle">{{ $receiptNumber }}</td>
                </tr>
            </table>
            <table class="w-full py-1">
                <tr>
                    <td class="text-[13px] font-semibold tracking-tight text-black pr-4 align-middle">Reservation #</td>
                    <td class="text-[13px] text-right text-black align-middle">{{ $r->reservation_number }}</td>
                </tr>
            </table>
            <table class="w-full py-1">
                <tr>
                    <td class="text-[13px] font-semibold tracking-tight text-black pr-4 align-middle">Paid Date</td>
                    <td class="text-[13px] text-right text-black align-middle">{{ $r->paid_at?->format('d M Y, H:i') ?? '-' }}</td>
                </tr>
            </table>
            <table class="w-full py-1">
                <tr>
...
<table class="w-full border-t border-gray-200 pt-4 mt-0 mb-4">
    <tr>
        <td>
            <div class="text-[13px] font-semibold text-black tracking-tight mb-2">Special Request:</div>
            <div class="text-[13px] text-black italic">{{ $r->special_request }}</div>
        </td>
    </tr>
</table>
@endif
