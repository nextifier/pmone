---
title: "Adding brands to events"
description: "How to assign exhibitor brands to an event and configure their booth details."
...
1. Open your event and go to the **Brands** tab
2. Click **Add brand**
3. Search for an existing brand, or create a new one
4. Fill in booth details: number, type, size, and price
5. Click **Save**
...
1. Click **Import** on the event's brand list
2. Download the Excel template
3. Fill in brand names, booth numbers, and other fields
...
- [Managing brand profiles](./02-managing-brand-profiles.md) - edit brand company info and media
