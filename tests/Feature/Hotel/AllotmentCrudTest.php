...
test('admin can list allotments for a hotel', function () {
    ...
    $response = $this->getJson("/api/events/{$this->event->id}/hotels/{$this->hotel->slug}/allotments");
...
test('admin can soft delete an allotment', function () {
    ...
    $response = $this->deleteJson("/api/events/{$this->event->id}/hotels/{$this->hotel->slug}/allotments/{$allotment->id}");
