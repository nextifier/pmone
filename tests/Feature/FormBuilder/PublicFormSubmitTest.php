...
dataset('valid field values', [
    ...
    'month' => ['month', '2026-07'],
    'month_range' => ['month_range', ['start' => '2026-03', 'end' => '2026-07']],
    'year' => ['year', 2024],
    'year_range' => ['year_range', ['start' => 2020, 'end' => 2024]],
    'time_range' => ['time_range', ['start' => '09:00', 'end' => '17:30']],
    'slider_range' => ['slider_range', ['start' => 10, 'end' => 40]],
    'slider_ruler' => ['slider_ruler', 55],
    ...
    'color' => ['color', '#2563eb'],
    'color with alpha' => ['color', '#2563eb80'],
...
dataset('invalid field values', [
    ...
    'month' => ['month', '2026-13'],
    'month bad format' => ['month', '07-2026'],
    'month_range inverted' => ['month_range', ['start' => '2026-07', 'end' => '2026-03']],
    'year below min' => ['year', 1850],
    'year not an integer' => ['year', 'abc'],
    'year_range inverted' => ['year_range', ['start' => 2024, 'end' => 2020]],
    'time_range inverted' => ['time_range', ['start' => '17:00', 'end' => '09:00']],
    'time_range bad format' => ['time_range', ['start' => '25:61', 'end' => '26:00']],
    'slider_range above max' => ['slider_range', ['start' => 10, 'end' => 9999]],
    'slider_range inverted' => ['slider_range', ['start' => 60, 'end' => 10]],
    'slider_ruler' => ['slider_ruler', 9999],
    ...
    'color' => ['color', 'blue'],
    'color with bad alpha' => ['color', '#2563eb8'],
